module cnn_opt (clk_i, aclk_i, reset_n_i, code_base_addr_i, rd_rdy_o, 
            start_i, lmmi_request_i, lmmi_wr_rdn_i, lmmi_offset_i, lmmi_wdata_i, 
            lmmi_ready_o, lmmi_rdata_valid_o, lmmi_rdata_o, we_o, dout_o, 
            debug_rdy_i, debug_vld_o, status_o, axi4_awid_o, axi4_awaddr_o, 
            axi4_awregion_o, axi4_awlen_o, axi4_awsize_o, axi4_awburst_o, 
            axi4_awlock_o, axi4_awcache_o, axi4_awprot_o, axi4_awqos_o, 
            axi4_awvalid_o, axi4_awready_i, axi4_wid_o, axi4_wdata_o, 
            axi4_wstrb_o, axi4_wlast_o, axi4_wvalid_o, axi4_wready_i, 
            axi4_bid_i, axi4_bresp_i, axi4_bvalid_i, axi4_bready_o, 
            axi4_arid_o, axi4_araddr_o, axi4_arregion_o, axi4_arlen_o, 
            axi4_arsize_o, axi4_arburst_o, axi4_arlock_o, axi4_arcache_o, 
            axi4_arprot_o, axi4_arqos_o, axi4_arvalid_o, axi4_arready_i, 
            axi4_rid_i, axi4_rdata_i, axi4_rresp_i, axi4_rlast_i, axi4_rvalid_i, 
            axi4_rready_o);
    input clk_i;
    input aclk_i;
    input reset_n_i;
